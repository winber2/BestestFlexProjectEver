...
class Comparison extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      options: { optionA: 'dijkstra', optionB: 'bellman-ford' },
      algorithms: [],
      graphAlgo: [],
      graph: null,
    };
  ...
  resetAlgorithms() {
    ...
    Object.keys(this.state.options).forEach((key, index) => {
      switch (this.state.options[key]) {
        case 'dijkstra':
          algorithms.push(
            new DijkstraSteps(NODELIST2, 1, 8, this.visual[index])
          );
          graphAlgo.push(Dijkstra);
          this.fetchCode('javascript/dijkstras.js');
          break;
        case 'astar':
        ...
        case 'bellman-ford':
          algorithms.push(
            new BellmanFordSteps(NODELIST2, 1, 8, this.visual[index])
          );
        ...
        case 'floyd-warshall':
          algorithms.push(
            new FloydWarshallSteps(NODELIST2, 1, 8, this.visual[index])
          );
  ...
  hidePlayButton() {
    ...
    button.style.backgroundImage = "url('../images/replay.png')";
  ...
  revealPlayButton() {
    ...
    buttonHolder.style.zIndex = '1';
    let button = document.getElementById('button');
    button.style.backgroundImage = "url('../images/play_button.png')";
  ...
  mouseOverEffect(e) {
    e.target.style.backgroundImage = "url('../images/play_button_hover.png')";
  }

  mouseOutEffect(e) {
    e.target.style.backgroundImage = "url('../images/play_button.png')";
  }
        ...
        <main className="comp-main">
          <section className="comp-main">
            <ul className="comp-visualization">
              <li>
                <select
                  onChange={this.handleSelectA}
                  value={this.state.options.optionA}
                >
              ...
              <li>
                <select
                  onChange={this.handleSelectB}
                  value={this.state.options.optionB}
                >
                  <option value="dijkstra">Dijkstra</option>
                  <option value="astar">A* Algorithm</option>
                  <option value="bellman-ford">Bellman-Ford</option>
